...
namespace Sunny.UI
{
    public sealed class UIDateTimeItem : UIDropDownItem, ITranslate
    {
        ...
        private void InitializeComponent()
        {
            ...
            uiPanel1.Font = new Font("Segoe UI", 9F);
