...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    public abstract class Mpr
    {
        ...
        [DllImport("mpr")] public static extern int WNetConnectionDialog(IntPtr IntPtr, int dwType);
        [DllImport("mpr")] public static extern int WNetDisconnectDialog(IntPtr IntPtr, int dwType);
