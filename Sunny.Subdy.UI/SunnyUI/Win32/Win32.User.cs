...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    public delegate int WNDPROC(IntPtr IntPtr, int msg, int wParam, int lParam);
    ...
    public abstract class ComCtl
    {
        ...
        [DllImport("COMCTL32")] public static extern int ImageList_Draw(Handle hIMAGELIST, int ImgIndex, IntPtr hdcDest, int xDest, int yDest, int lStyle);
    ...
    public partial class User
    {
        ...
        [DllImport("user32")] public static extern int ArrangeIconicWindows(IntPtr IntPtr);
        ...
        public static extern IntPtr BeginPaint(IntPtr IntPtr, ref PAINTSTRUCT lpPaint);
        [DllImport("user32")] public static extern int BringWindowToTop(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int CallWindowProc(int lpPrevWndFunc, IntPtr IntPtr, int Msg, int wParam, int lParam);
        [DllImport("user32")] public static extern int ChangeClipboardChain(IntPtr IntPtr, IntPtr IntPtrNext);
        ...
        [DllImport("user32")] public static extern int ChildWindowFromPoint(IntPtr IntPtr, int xPoint, int yPoint);
        [DllImport("user32")] public static extern int ChildWindowFromPointEx(IntPtr IntPtr, int xPoint, int yPoint, int un);
        [DllImport("user32")] public static extern int ClientToScreen(IntPtr IntPtr, ref POINT lpPoint);
        ...
        [DllImport("user32")] public static extern int CloseWindow(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int CreateCaret(IntPtr IntPtr, Handle hBitmap, int nWidth, int nHeight);
        ...
        [DllImport("user32")] public static extern int CreateDialogIndirectParam(Handle hInstance, ref DLGTEMPLATE lpTemplate, IntPtr IntPtrParent, ref int lpDialogFunc, int dwInitParam);
        [DllImport("user32")] public static extern int CreateDialogParam(Handle hInstance, string lpName, IntPtr IntPtrParent, ref int lpDialogFunc, int lParamInit);
        ...
        [DllImport("user32")] public static extern int CreateMDIWindow(string lpClassName, string lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, IntPtr IntPtrParent, Handle hInstance, int lParam);
        [DllImport("user32")] public static extern int CreateMenu();
        [DllImport("user32")] public static extern int CreatePopupMenu();
        //[DllImport("user32")] public static extern int CreateWindowEx(int dwExStyle, string lpClassName, string lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, IntPtr IntPtrParent, Handle hMenu, Handle hInstance, IntPtr lpParam);
        [DllImport("user32.dll", CharSet = CharSet.Unicode)]
        public static extern IntPtr CreateWindowEx(int dwExStyle, string lpszClassName, string lpszWindowName, int style, int x, int y, int width, int height, IntPtr IntPtrParent, IntPtr hMenu, IntPtr hInst, object pvParam);
        ...
        [DllImport("user32")] public static extern int DdeSetQualityOfService(IntPtr IntPtrClient, ref SECURITY_QUALITY_OF_SERVICE pqosNew, ref SECURITY_QUALITY_OF_SERVICE pqosPrev);
        ...
        [DllImport("user32")] public static extern int DefFrameProc(IntPtr IntPtr, IntPtr IntPtrMDIClient, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern int DefMDIChildProc(IntPtr IntPtr, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern int DefWindowProc(IntPtr IntPtr, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern int DeferWindowPos(Handle hWinPosInfo, IntPtr IntPtr, IntPtr IntPtrInsertAfter, int x, int y, int cx, int cy, int wFlags);
        ...
        [DllImport("user32")] public static extern int DestroyWindow(IntPtr IntPtr);
        [DllImport("user32")] public static extern int DialogBoxIndirectParam(Handle hInstance, DLGTEMPLATE hDialogTemplate, IntPtr IntPtrParent, ref int lpDialogFunc, int dwInitParam);
        ...
        [DllImport("user32")] public static extern int DlgDirSelectComboBoxEx(IntPtr IntPtrDlg, string lpszPath, int cbPath, int idComboBox);
        [DllImport("user32")] public static extern int DlgDirSelectEx(IntPtr IntPtrDlg, string lpszPath, int cbPath, int idListBox);
        [DllImport("user32")] public static extern int DragDetect(IntPtr IntPtr, POINT pt);
        [DllImport("user32")] public static extern int DragObject(IntPtr IntPtr1, IntPtr IntPtr2, int un, int dw, Handle hCursor);
        [DllImport("user32")] public static extern int DrawAnimatedRects(IntPtr IntPtr, int idAni, ref RECT lprcFrom, ref RECT lprcTo);
        [DllImport("user32")] public static extern int DrawCaption(IntPtr IntPtr, IntPtr intPtr, ref RECT pcRect, int un);
        [DllImport("user32")] public static extern int DrawEdge(IntPtr hdc, ref RECT qrc, int edge, int grfFlags);
        [DllImport("user32")] public static extern int DrawFocusRect(IntPtr IntPtr, ref RECT lpRect);
        [DllImport("user32")] public static extern int DrawFrameControl(IntPtr IntPtr, ref RECT lpRect, int un1, int un2);
        [DllImport("user32")] public static extern int DrawIcon(IntPtr IntPtr, int x, int y, Handle hIcon);
        [DllImport("user32")] public static extern int DrawIconEx(IntPtr IntPtr, int xLeft, int yTop, Handle hIcon, int cxWidth, int cyWidth, int istepIfAniCur, Handle hbrFlickerFreeDraw, int diFlags);
        [DllImport("user32")] public static extern int DrawMenuBar(IntPtr IntPtr);
        [DllImport("user32")] public static extern int DrawState(IntPtr IntPtr, Handle hBrush, ref int lpDrawStateProc, int lParam, int wParam, int n1, int n2, int n3, int n4, int un);
        [DllImport("user32")] public static extern int DrawText(IntPtr IntPtr, string lpStr, int nCount, ref RECT lpRect, int wFormat);
        [DllImport("user32")] public static extern int DrawTextEx(IntPtr IntPtr, string lpsz, int n, ref RECT lpRect, int un, ref DRAWTEXTPARAMS lpDrawTextParams);
        [DllImport("user32")]
        public static extern int DrawTextEx(IntPtr IntPtr, string lpsz, int n, ref RECT lpRect, int un, IntPtr lpDrawTextParams);
        ...
        [DllImport("user32")] public static extern int EnableScrollBar(IntPtr IntPtr, int wSBflags, int wArrows);
        [DllImport("user32")] public static extern int EnableWindow(IntPtr IntPtr, int fEnable);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool EndPaint(IntPtr IntPtr, ref PAINTSTRUCT lpPaint);
        [DllImport("user32")] public static extern int EnumChildWindows(IntPtr IntPtrParent, ref int lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern int EnumProps(IntPtr IntPtr, ref int lpEnumFunc);
        [DllImport("user32")] public static extern int EnumPropsEx(IntPtr IntPtr, ref int lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern int ExcludeUpdateRgn(IntPtr IntPtr, IntPtr intPtr);
        ...
        [DllImport("user32")] public static extern int FillRect(IntPtr IntPtr, ref RECT lpRect, Handle hBrush);
        [DllImport("user32")] public static extern int FindWindow(string lpClassName, string lpWindowName);
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Auto)]
        public static extern IntPtr FindWindowEx(IntPtr IntPtrParent, IntPtr IntPtrChildAfter, string? lpszClass, string? lpszWindow);
        [DllImport("user32")] public static extern int FlashWindow(IntPtr IntPtr, int bInvert);
        [DllImport("user32")] public static extern int FrameRect(IntPtr IntPtr, ref RECT lpRect, Handle hBrush);
        ...
        [DllImport("user32")] public static extern int GetClassLong(IntPtr IntPtr, int nIndex);
        [DllImport("user32")] public static extern int GetClassName(IntPtr IntPtr, StringBuilder lpClassName, int nMaxCount);
        [DllImport("user32")] public static extern int GetClassWord(IntPtr IntPtr, int nIndex);
        [DllImport("user32")] public static extern int GetClientRect(IntPtr IntPtr, ref RECT lpRect);
        ...
        [DllImport("user32")] public static extern IntPtr GetDC(IntPtr IntPtr);
        [DllImport("user32")] public static extern int GetDCEx(IntPtr IntPtr, Handle hrgnclip, int fdwOptions);
        [DllImport("user32")] public static extern int GetDesktopWindow();
        [DllImport("user32")] public static extern int GetDialogBaseUnits();
        [DllImport("user32")] public static extern int GetDlgCtrlID(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int GetLastActivePopup(IntPtr IntPtrOwnder);
        [DllImport("user32")] public static extern int GetMenu(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int GetMenuItemRect(IntPtr IntPtr, Handle hMenu, int uItem, ref RECT lprcItem);
        ...
        [DllImport("user32")] public static extern int GetMessage(ref MSG lpMsg, IntPtr IntPtr, int wMsgFilterMin, int wMsgFilterMax);
        ...
        [DllImport("user32")] public static extern int GetNextWindow(IntPtr IntPtr, int wFlag);
        [DllImport("user32")] public static extern int GetOpenClipboardWindow();
        [DllImport("user32")] public static extern int GetParent(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int GetProp(IntPtr IntPtr, string lpString);
        [DllImport("user32")] public static extern int GetQueueStatus(int fuFlags);
        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool GetScrollInfo(IntPtr IntPtr, int nBar, ref SCROLLINFO lpScrollInfo);
        [DllImport("user32")] public static extern int GetScrollPos(IntPtr IntPtr, int nBar);
        [DllImport("user32")] public static extern int GetScrollRange(IntPtr IntPtr, int nBar, ref int lpMinPos, ref int lpMaxPos);
        ...
        [DllImport("user32")] public static extern int GetSystemMenu(IntPtr IntPtr, int bRevert);
        [DllImport("user32")] public static extern int GetSystemMetrics(int nIndex);
        [DllImport("user32")] public static extern int GetTabbedTextExtent(IntPtr hdc, string lpString, int nCount, int nTabPositions, ref int lpnTabStopPositions);
        [DllImport("user32")] public static extern int GetThreadDesktop(int dwThread);
        [DllImport("user32")] public static extern int GetTopWindow(IntPtr IntPtr);
        [DllImport("user32")] public static extern int GetUpdateRect(IntPtr IntPtr, ref RECT lpRect, int bErase);
        [DllImport("user32")] public static extern int GetUpdateRgn(IntPtr IntPtr, Handle hRgn, int fErase);
        ...
        [DllImport("user32")] public static extern int GetWindow(IntPtr IntPtr, int wCmd);
        [DllImport("user32")] public static extern int GetWindowContextHelpId(IntPtr IntPtr);
        [DllImport("user32.dll")]
        public static extern IntPtr GetWindowDC(IntPtr IntPtr);
        [DllImport("user32.dll", SetLastError = true)]
        public static extern int GetWindowLong(IntPtr IntPtr, int nIndex);
        [DllImport("user32")] public static extern int GetWindowPlacement(IntPtr IntPtr, ref WINDOWPLACEMENT lpwndpl);
        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool GetWindowRect(IntPtr IntPtr, out RECT lpRect);
        [DllImport("user32")] public static extern int GetWindowRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("user32")] public static extern int GetWindowText(IntPtr IntPtr, StringBuilder lpString, int cch);
        [DllImport("user32")] public static extern int GetWindowTextLength(IntPtr IntPtr);
        [DllImport("user32")] public static extern int GetWindowThreadProcessId(IntPtr IntPtr, ref int lpdwProcessId);
        [DllImport("user32")] public static extern int GrayString(IntPtr hdc, Handle hBrush, ref int lpOutputFunc, ref int lpData, int nCount, int X, int Y, int nWidth, int nHeight);
        [DllImport("user32")] public static extern int HideCaret(IntPtr IntPtr);
        [DllImport("user32")] public static extern int HiliteMenuItem(IntPtr IntPtr, Handle hMenu, int wIDHiliteItem, int wHilite);
        [DllImport("user32")] public static extern int ImpersonateDdeClientWindow(IntPtr IntPtrClient, IntPtr IntPtrServer);
        ...
        [DllImport("user32")] public static extern int InvalidateRect(IntPtr IntPtr, ref RECT lpRect, int bErase);
        [DllImport("user32")] public static extern int InvalidateRgn(IntPtr IntPtr, Handle hRgn, int bErase);
        [DllImport("user32")] public static extern int InvertRect(IntPtr hdc, ref RECT lpRect);
        ...
        [DllImport("user32")] public static extern int IsChild(IntPtr IntPtrParent, IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int IsIconic(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int IsWindow(IntPtr IntPtr);
        [DllImport("user32")] public static extern int IsWindowEnabled(IntPtr IntPtr);
        [DllImport("user32")] public static extern int IsWindowUnicode(IntPtr IntPtr);
        [DllImport("user32")] public static extern int IsWindowVisible(IntPtr IntPtr);
        [DllImport("user32.dll")]
        public static extern int IsZoomed(IntPtr IntPtr);
        [DllImport("user32")] public static extern int KillTimer(IntPtr IntPtr, int nIDEvent);
        ...
        [DllImport("user32")] public static extern int LockWindowUpdate(IntPtr IntPtrLock);
        ...
        [DllImport("user32")] public static extern int MapWindowPoints(IntPtr IntPtrFrom, IntPtr IntPtrTo, POINT[] lppt, int cPoints);
        [DllImport("user32")] public static extern int MenuItemFromPoint(IntPtr IntPtr, Handle hMenu, POINT ptScreen);
        [DllImport("user32")] public static extern int MessageBeep(int wType);
        [DllImport("user32")] public static extern int MessageBox(IntPtr IntPtr, string lpText, string lpCaption, int wType);
        [DllImport("user32")] public static extern int MessageBoxEx(IntPtr IntPtr, string lpText, string lpCaption, int uType, int wLanguageId);
        ...
        [DllImport("user32")] public static extern int MoveWindow(IntPtr IntPtr, int x, int y, int nWidth, int nHeight, int bRepaint);
        ...
        [DllImport("user32")] public static extern int OpenClipboard(IntPtr IntPtr);
        [DllImport("user32")] public static extern int OpenDesktop(string lpszDesktop, int dwFlags, int fInherit, int dwDesiredAccess);
        [DllImport("user32")] public static extern int OpenIcon(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int PaintDesktop(IntPtr hdc);
        [DllImport("user32")] public static extern int PeekMessage(ref MSG lpMsg, IntPtr IntPtr, int wMsgFilterMin, int wMsgFilterMax, int wRemoveMsg);
        [DllImport("user32")] public static extern int PostMessage(IntPtr IntPtr, int wMsg, int wParam, int lParam);
        ...
        [DllImport("user32")] public static extern int RedrawWindow(IntPtr IntPtr, ref RECT lprcUpdate, Handle hrgnUpdate, int fuRedraw);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern int RegisterHotKey(IntPtr IntPtr, int id, int fsModifiers, int vk);
        ...
        [DllImport("user32")] public static extern int RemoveProp(IntPtr IntPtr, string lpString);
        ...
        [DllImport("user32")] public static extern int ScreenToClient(IntPtr IntPtr, ref POINT lpPoint);
        [DllImport("user32")] public static extern int ScrollDC(IntPtr hdc, int dx, int dy, ref RECT lprcScroll, ref RECT lprcClip, Handle hrgnUpdate, ref RECT lprcUpdate);
        [DllImport("user32")] public static extern int ScrollWindow(IntPtr IntPtr, int XAmount, int YAmount, ref RECT lpRect, ref RECT lpClipRect);
        [DllImport("user32")] public static extern int ScrollWindowEx(IntPtr IntPtr, int dx, int dy, ref RECT lprcScroll, ref RECT lprcClip, Handle hrgnUpdate, ref RECT lprcUpdate, int fuScroll);
        [DllImport("user32")] public static extern int SendDlgItemMessage(Handle hDlg, int nIDDlgItem, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern int SendMessage(IntPtr IntPtr, int wMsg, int wParam, int lParam);
        [DllImport("user32")] public static extern int SendMessageCallback(IntPtr IntPtr, int msg, int wParam, int lParam, ref int lpResultCallBack, int dwData);
        [DllImport("user32")] public static extern int SendMessageTimeout(IntPtr IntPtr, int msg, int wParam, int lParam, int fuFlags, int uTimeout, ref int lpdwResult);
        [DllImport("user32")] public static extern int SendNotifyMessage(IntPtr IntPtr, int msg, int wParam, int lParam);
        [DllImport("user32")] public static extern int SetActiveWindow(IntPtr IntPtr);
        [DllImport("user32")] public static extern int SetCapture(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int SetClassLong(IntPtr IntPtr, int nIndex, int dwNewLong);
        [DllImport("user32")] public static extern int SetClassWord(IntPtr IntPtr, int nIndex, int wNewWord);
        [DllImport("user32")] public static extern int SetClipboardData(int wFormat, Handle hMem);
        [DllImport("user32")] public static extern int SetClipboardViewer(IntPtr IntPtr);
        ...
        [DllImport("user32")] public static extern int SetFocus(IntPtr IntPtr);
        [DllImport("user32.dll")]
        ...
        [DllImport("user32")] public static extern int SetMenu(IntPtr IntPtr, Handle hMenu);
        ...
        [DllImport("user32")] public static extern int SetParent(IntPtr IntPtrChild, IntPtr IntPtrNewParent);
        [DllImport("user32")] public static extern int SetProcessWindowStation(Handle hWinSta);
        [DllImport("user32")] public static extern int SetProp(IntPtr IntPtr, string lpString, Handle hData);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern int SetScrollInfo(IntPtr IntPtr, int nBar, ref SCROLLINFO lpcScrollInfo, bool redraw);
        [DllImport("user32")] public static extern int SetScrollPos(IntPtr IntPtr, int nBar, int nPos, int bRedraw);
        [DllImport("user32")] public static extern int SetScrollRange(IntPtr IntPtr, int nBar, int nMinPos, int nMaxPos, int bRedraw);
        ...
        //[DllImport("user32")] public static extern int SetTimer(IntPtr IntPtr, int nIDEvent, int uElapse, ref int lpTimerFunc);
        [DllImport("user32")] public static extern int SetTimer(IntPtr IntPtr, int nIDEvent, int uElapse, IntPtr lpTimerFunc);
        ...
        [DllImport("user32")] public static extern int SetWindowContextHelpId(IntPtr IntPtr, int dw);
        [DllImport("user32")] public static extern int SetWindowLong(IntPtr IntPtr, int nIndex, int dwNewLong);
        [DllImport("user32")] public static extern int SetWindowPlacement(IntPtr IntPtr, ref WINDOWPLACEMENT lpwndpl);
        [DllImport("user32")] public static extern int SetWindowPos(IntPtr IntPtr, IntPtr IntPtrInsertAfter, int x, int y, int cx, int cy, int wFlags);
        [DllImport("user32")] public static extern int SetWindowRgn(IntPtr IntPtr, Handle hRgn, int bRedraw);
        [DllImport("user32")] public static extern int SetWindowText(IntPtr IntPtr, string lpString);
        [DllImport("user32")] public static extern int SetWindowWord(IntPtr IntPtr, int nIndex, int wNewWord);
        ...
        [DllImport("user32")] public static extern int ShowCaret(IntPtr IntPtr);
        [DllImport("user32")] public static extern int ShowCursor(int bShow);
        [DllImport("user32")] public static extern int ShowOwnedPopups(IntPtr IntPtr, int fShow);
        [DllImport("user32")] public static extern int ShowScrollBar(IntPtr IntPtr, int wBar, int bShow);
        [DllImport("user32")] public static extern int ShowWindow(IntPtr IntPtr, int nCmdShow);
        [DllImport("user32.dll")]
        public static extern bool ShowWindowAsync(IntPtr IntPtr, int nCmdShow);
        ...
        [DllImport("user32")] public static extern int TabbedTextOut(IntPtr hdc, int x, int y, string lpString, int nCount, int nTabPositions, ref int lpnTabStopPositions, int nTabOrigin);
        ...
        [DllImport("user32")] public static extern int TrackPopupMenu(Handle hMenu, int wFlags, int x, int y, int nReserved, IntPtr IntPtr, ref RECT lprc);
        [DllImport("user32")] public static extern int TrackPopupMenuEx(Handle hMenu, int un, int n1, int n2, IntPtr IntPtr, ref TPMPARAMS lpTPMParams);
        [DllImport("user32")] public static extern int TranslateAccelerator(IntPtr IntPtr, Handle hAccTable, ref MSG lpMsg);
        [DllImport("user32")] public static extern int TranslateMDISysAccel(IntPtr IntPtrClient, ref MSG lpMsg);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern int UnregisterHotKey(IntPtr IntPtr, int id);
        [DllImport("user32")] public static extern int UpdateWindow(IntPtr IntPtr);
        [DllImport("user32")] public static extern int ValidateRect(IntPtr IntPtr, ref RECT lpRect);
        [DllImport("user32")] public static extern int ValidateRgn(IntPtr IntPtr, Handle hRgn);
        ...
        [DllImport("user32")] public static extern int WinHelp(IntPtr IntPtr, string lpHelpFile, int wCommand, int dwData);
        [DllImport("user32")] public static extern int WindowFromDC(IntPtr hdc);
        [DllImport("user32")] public static extern int WindowFromPoint(int xPoint, int yPoint);
        [DllImport("user32")] public static extern short CascadeWindows(IntPtr IntPtrParent, int wHow, ref RECT lpRect, int cKids, ref int lpkids);
        ...
        [DllImport("user32")] public static extern short GetWindowWord(IntPtr IntPtr, int nIndex);

        [DllImport("user32", CharSet = CharSet.Auto)]
        public static extern short RegisterClassEx(ref WNDCLASSEX pcWndClassEx);
        [DllImport("user32")] public static extern short TileWindows(IntPtr IntPtrParent, int wHow, ref RECT lpRect, int cKids, ref int lpKids);
