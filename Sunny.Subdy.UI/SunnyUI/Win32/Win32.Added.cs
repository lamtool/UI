...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    public static class Win32Helper
    {
        ...
        public static int WriteMemoryValue(string processName, int baseAddress, byte[] buffer)
        {
            try
            {
                ...
                int count = 0;
                //从指定内存中写入字节集数据
                Kernel.WriteProcessMemory(hProcess, (IntPtr)baseAddress, byteAddress, buffer.Length, out count);
                //关闭操作
                Kernel.CloseHandle(hProcess);
                return count;
            }
    ...
    public partial class User
    {
        ...
        public static extern IntPtr SendMessage(IntPtr IntPtr, int msg, int wParam, string lParam);
        ...
        public static extern bool MoveWindow(IntPtr IntPtr, int x, int y, int nWidth, int nHeight, bool bRepaint = true);
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool ShowScrollBar(IntPtr IntPtr, int wBar, bool bShow);
    ...
    public class Dwm
    {
        ...
        public static extern int DwmExtendFrameIntoClientArea(IntPtr IntPtr, ref MARGINS pMarInset);

        [DllImport("dwmapi.dll")]
        public static extern int DwmSetWindowAttribute(IntPtr IntPtr, int attr, ref int attrValue, int attrSize);
