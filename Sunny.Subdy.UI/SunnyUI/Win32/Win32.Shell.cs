...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    public abstract class Shell
    {
        ...
        [DllImport("shell32")] public static extern int ShellAbout(IntPtr IntPtr, string szApp, string szOtherStuff, Handle hIcon);
        [DllImport("shell32")] public static extern int ShellExecute(IntPtr IntPtr, string lpOperation, string lpFile, string lpParameters, string lpDirectory, int nShowCmd);
        [DllImport("shell32")] public static extern int Shell_NotifyIcon(int dwMessage, ref NOTIFYICONDATA lpData);
        [DllImport("shell32")] public static extern void DragAcceptFiles(IntPtr IntPtr, int fAccept);
        ...
        [DllImport("shell32")] public static extern void WinExecError(IntPtr IntPtr, int error, string lpstrFileName, string lpstrTitle);
