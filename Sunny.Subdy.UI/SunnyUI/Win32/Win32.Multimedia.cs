...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    public partial class WinMM
    {
        ...
        [DllImport("winmm")] public static extern int joySetCapture(IntPtr IntPtr, int uID, int uPeriod, int bChanged);
        ...
        [DllImport("winmm")]
        public static extern int mciSendString(string lpstrCommand, StringBuilder lpstrReturnString, int uReturnLength, IntPtr IntPtrCallback);
        ...
        public const int MCI_ANIM_STATUS_IntPtr = 0x4003;
        ...
        public const int MCI_ANIM_WINDOW_IntPtr = 0x10000;
        ...
        public const int MCI_BREAK_IntPtr = 0x200;
        ...
        public const int MCI_OVLY_STATUS_IntPtr = 0x4001;
        ...
        public const int MCI_OVLY_WINDOW_IntPtr = 0x10000;
