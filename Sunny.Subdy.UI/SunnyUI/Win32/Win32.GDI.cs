...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    {
        [DllImport("gdi32.dll")] public static extern int AbortDoc(IntPtr IntPtr);
        [DllImport("gdi32.dll")] public static extern int AbortPath(IntPtr IntPtr);
        [DllImport("gdi32.dll")] public static extern int AddFontResource(string lpFileName);
        [DllImport("gdi32.dll")] public static extern int AngleArc(IntPtr hdc, int x, int y, int dwRadius, float eStartAngle, float eSweepAngle);
        [DllImport("gdi32.dll")] public static extern int AnimatePalette(IntPtr hPalette, int wStartIndex, int wNumEntries, [In] PALETTEENTRY[] lpPaletteColors);
        [DllImport("gdi32.dll")] public static extern int Arc(IntPtr hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32.dll")] public static extern int ArcTo(IntPtr hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32.dll")] public static extern int BeginPath(IntPtr hdc);
        ...
        [DllImport("gdi32.dll")] public static extern int CancelDC(IntPtr hdc);
        [DllImport("gdi32.dll")] public static extern int CheckColorsInGamut(IntPtr hdc, IntPtr lpv, IntPtr lpv2, int dw);
        [DllImport("gdi32.dll")] public static extern int ChoosePixelFormat(IntPtr hdc, ref PIXELFORMATDESCRIPTOR pPixelFormatDescriptor);
        [DllImport("gdi32.dll")] public static extern int Chord(IntPtr hdc, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32.dll")] public static extern IntPtr CloseEnhMetaFile(IntPtr hdc);
        [DllImport("gdi32.dll")] public static extern int CloseFigure(IntPtr hdc);
        [DllImport("gdi32")] public static extern int CloseMetaFile(Handle hMF);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern int ColorMatchToTarget(IntPtr hdc, IntPtr hdcTarget, int action);
        ...
        [DllImport("gdi32")] public static extern int CreateCompatibleBitmap(IntPtr hdc, int nWidth, int nHeight);
        [DllImport("gdi32")] public static extern int CreateCompatibleDC(IntPtr hdc);
        ...
        public static extern IntPtr CreateDIBSection(
            ...
            IntPtr hSection,
            uint dwOffset);
        [DllImport("gdi32")] public static extern int CreateDIBitmap(IntPtr hdc, ref BITMAPINFOHEADER lpInfoHeader, int dwUsage, IntPtr lpInitBits, ref BITMAPINFO lpInitInfo, int wUsage);
        [DllImport("gdi32")] public static extern int CreateDiscardableBitmap(IntPtr hdc, int nWidth, int nHeight);
    ...
    string lpDescription);
        ...
        [DllImport("gdi32")] public static extern int CreateHalftonePalette(IntPtr hdc);
        ...
        [DllImport("gdi32")] public static extern int DPtoLP(IntPtr hdc, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")] public static extern int DeleteColorSpace(Handle hcolorspace);
        [DllImport("gdi32")] public static extern int DeleteDC(IntPtr hdc);
    ...
    ref PIXELFORMATDESCRIPTOR ppfd);
        [DllImport("gdi32")] public static extern int DrawEscape(IntPtr IntPtr, int nEscape, int cbInput, string lpszInData);
        [DllImport("gdi32")] public static extern int Ellipse(IntPtr IntPtr, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")] public static extern int EndDoc(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int EndPage(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int EndPath(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int EnumEnhMetaFile(IntPtr IntPtr, Handle hemf, ref int lpEnhMetaFunc, IntPtr lpData, ref RECT lpRect);
        [DllImport("gdi32")] public static extern int EnumFontFamilies(IntPtr IntPtr, string lpszFamily, ref int lpEnumFontFamProc, int lParam);
        [DllImport("gdi32")] public static extern int EnumFontFamiliesEx(IntPtr IntPtr, ref LOGFONT lpLogFont, ref int lpEnumFontProc, int lParam, int dw);
        public delegate int FONTENUMPROC(
            ref LOGFONT lpelf,    // con trỏ tới LOGFONT struct
            ref TEXTMETRIC lpntm, // con trỏ tới TEXTMETRIC struct
            uint FontType,        // kiểu font
            IntPtr lParam);       // tham số tùy ý

        [DllImport("gdi32.dll", CharSet = CharSet.Auto)]
        public static extern int EnumFonts(
            IntPtr hdc,           // handle device context
            string lpFaceName,    // tên font, null để lấy tất cả
            FONTENUMPROC lpFontEnumProc,  // callback
            IntPtr lParam);
        [DllImport("gdi32")] public static extern int EnumICMProfiles(IntPtr IntPtr, int icmEnumProc, int lParam);
        // Delegate cho EnumMetaFileProc
        public delegate int MFENUMPROC(IntPtr hdc, IntPtr lpHTable, IntPtr lpMFR, IntPtr lpData);

        [DllImport("gdi32.dll")]
        public static extern int EnumMetaFile(
            IntPtr hdc,
            IntPtr hmf,           // handle metafile
            MFENUMPROC lpEnumFunc,
            IntPtr lpData);

        // Delegate cho EnumObjectsProc
        public delegate int GOBJENUMPROC(IntPtr lpLogObject, IntPtr lpData);
        ...
        [DllImport("gdi32")] public static extern int Escape(IntPtr IntPtr, int nEscape, int nCount, string lpInData, IntPtr lpOutData);
        [DllImport("gdi32")] public static extern int ExcludeClipRect(IntPtr IntPtr, int X1, int Y1, int X2, int Y2);
        ...
        [DllImport("gdi32")] public static extern int ExtEscape(IntPtr IntPtr, int nEscape, int cbInput, string lpszInData, int cbOutput, string lpszOutData);
        [DllImport("gdi32")] public static extern int ExtFloodFill(IntPtr IntPtr, int x, int y, int crColor, int wFillType);
        [DllImport("gdi32")] public static extern int ExtSelectClipRgn(IntPtr IntPtr, Handle hRgn, int fnMode);
        [DllImport("gdi32", EntryPoint = "ExtTextOutW", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int ExtTextOut(IntPtr IntPtr, int x, int y, int wOptions, ref RECT lpRect, string lpString, int nCount, IntPtr lpDx);
        [DllImport("gdi32", EntryPoint = "ExtTextOutW", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int ExtTextOut(IntPtr IntPtr, int x, int y, int wOptions, IntPtr lpRect, string lpString, int nCount, IntPtr lpDx);
        [DllImport("gdi32")] public static extern int FillPath(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int FillRgn(IntPtr IntPtr, Handle hRgn, Handle hBrush);
        [DllImport("gdi32.dll")]
      ...
      int y,
      ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int FlattenPath(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int FloodFill(IntPtr IntPtr, int x, int y, int crColor);
        [DllImport("gdi32")] public static extern int FrameRgn(IntPtr IntPtr, Handle hRgn, Handle hBrush, int nWidth, int nHeight);
        [DllImport("gdi32")] public static extern int GdiComment(IntPtr IntPtr, int cbSize, Byte lpData);
        ...
        [DllImport("gdi32")] public static extern int GetArcDirection(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetAspectRatioFilterEx(IntPtr IntPtr, ref SIZE lpAspectRatio);
        ...
        [DllImport("gdi32")] public static extern int GetBkColor(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetBkMode(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetBoundsRect(IntPtr IntPtr, ref RECT lprcBounds, int flags);
        [DllImport("gdi32.dll")]
        public static extern bool GetBrushOrgEx(
          IntPtr hdc,
          out POINT lpPoint);
        [DllImport("gdi32")] public static extern int GetCharABCWidths(IntPtr IntPtr, int uFirstChar, int uLastChar, ref ABC lpabc);
        [DllImport("gdi32")] public static extern int GetCharABCWidthsFloat(IntPtr IntPtr, int iFirstChar, int iLastChar, ref ABCFLOAT lpABCF);
        [DllImport("gdi32")] public static extern int GetCharWidth(IntPtr IntPtr, int wFirstChar, int wLastChar, int[] lpBuffer);
        [DllImport("gdi32")] public static extern int GetCharWidth32(IntPtr IntPtr, int iFirstChar, int iLastChar, int[] lpBuffer);
        [DllImport("gdi32")] public static extern int GetCharWidthFloat(IntPtr IntPtr, int iFirstChar, int iLastChar, double[] pxBuffer);
        [DllImport("gdi32")] public static extern int GetCharacterPlacement(IntPtr IntPtr, string lpsz, int n1, int n2, ref GCP_RESULTS lpGcpResults, int dw);
        [DllImport("gdi32")] public static extern int GetClipBox(IntPtr IntPtr, ref RECT lpRect);
        [DllImport("gdi32")] public static extern int GetClipRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("gdi32")] public static extern int GetColorAdjustment(IntPtr IntPtr, ref COLORADJUSTMENT lpca);
        [DllImport("gdi32")] public static extern int GetColorSpace(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetCurrentObject(IntPtr IntPtr, int uObjectType);
        [DllImport("gdi32")] public static extern int GetCurrentPositionEx(IntPtr IntPtr, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int GetDCOrgEx(IntPtr IntPtr, ref POINT lpPoint);
        [DllImport("gdi32.dll")]
       ...
       uint cEntries,
       [Out] RGBQUAD[] pColors);
        [DllImport("gdi32")] public static extern int GetDIBits(int aIntPtr, Handle hBitmap, int nStartScan, int nNumScans, IntPtr lpBits, ref BITMAPINFO lpBI, int wUsage);
        [DllImport("gdi32")] public static extern int GetDeviceCaps(IntPtr IntPtr, int nIndex);
        [DllImport("gdi32")] public static extern int GetDeviceGammaRamp(IntPtr IntPtr, IntPtr lpv);
        ...
        //jt[DllImport("gdi32")] public static extern int GetFontData(IntPtr IntPtr, int dwTable, int dwOffset, IntPtr lpvBuffer, int cbData);
        [DllImport("gdi32")] public static extern int GetFontData(IntPtr IntPtr, int dwTable, int dwOffset, ref TT_HHEA lpvBuffer, int cbData);
        [DllImport("gdi32")] public static extern int GetFontLanguageInfo(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetGlyphOutline(IntPtr IntPtr, int uChar, int fuFormat, ref GLYPHMETRICS lpgm, int cbBuffer, IntPtr lpBuffer, ref MAT2 lpmat2);
        [DllImport("gdi32")] public static extern int GetGraphicsMode(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetICMProfile(IntPtr IntPtr, int dw, string lpStr);
        [DllImport("gdi32")] public static extern int GetKerningPairs(IntPtr IntPtr, int cPairs, ref KERNINGPAIR lpkrnpair);
        [DllImport("gdi32")] public static extern int GetLogColorSpace(Handle hcolorspace, ref LOGCOLORSPACE lplogcolorspace, int dw);
        [DllImport("gdi32")] public static extern int GetMapMode(IntPtr IntPtr);
        ...
        [DllImport("gdi32")] public static extern int GetMetaRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("gdi32")] public static extern int GetMiterLimit(IntPtr IntPtr, double peLimit);
        [DllImport("gdi32")] public static extern int GetNearestColor(IntPtr IntPtr, int crColor);
        ...
        public static extern uint GetOutlineTextMetrics(IntPtr IntPtr, uint cbData, IntPtr lpotm);
        //[DllImport("gdi32", EntryPoint = "GetOutlineTextMetricsW", CharSet = CharSet.Unicode, ExactSpelling = true)] 
        //public static extern int GetOutlineTextMetrics(IntPtr IntPtr, int cbData, ref OUTLINETEXTMETRICW lpotm);
        ...
        [DllImport("gdi32")] public static extern int GetPath(IntPtr IntPtr, ref POINT lpPoint, Byte lpTypes, int nSize);
        [DllImport("gdi32")] public static extern int GetPixel(IntPtr IntPtr, int x, int y);
        [DllImport("gdi32.dll")]
        public static extern int GetPixelFormat(IntPtr hdc);
        [DllImport("gdi32")] public static extern int GetPolyFillMode(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetROP2(IntPtr IntPtr);
        ...
        [DllImport("gdi32")] public static extern int GetStretchBltMode(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetSystemPaletteEntries(IntPtr IntPtr, int wStartIndex, int wNumEntries, ref PALETTEENTRY lpPaletteEntries);
        [DllImport("gdi32")] public static extern int GetSystemPaletteUse(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetTextAlign(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetTextCharacterExtra(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetTextCharset(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int GetTextCharsetInfo(IntPtr IntPtr, ref FONTSIGNATURE lpSig, int dwFlags);
        [DllImport("gdi32")] public static extern int GetTextColor(IntPtr IntPtr);

        [DllImport("gdi32", EntryPoint = "GetTextExtentExPointW", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int GetTextExtentExPoint(IntPtr IntPtr, string lpszStr, int cchString, int nMaxExtent, int lpnFit, int[] alpDx, ref SIZE lpSize);

        [DllImport("gdi32", EntryPoint = "GetTextExtentExPointW", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int GetTextExtentExPoint(IntPtr IntPtr, string lpszStr, int cchString, int nMaxExtent, IntPtr lpnFit, int[] alpDx, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int GetTextExtentPoint(IntPtr IntPtr, string lpszString, int cbString, ref SIZE lpSize);

        [DllImport("gdi32", EntryPoint = "GetTextExtentPoint32W", CharSet = CharSet.Unicode, ExactSpelling = true)]
        public static extern int GetTextExtentPoint32(IntPtr IntPtr, string lpsz, int cbString, ref SIZE lpSize);

        [DllImport("gdi32")] public static extern int GetTextFace(IntPtr IntPtr, int nCount, string lpFacename);
        [DllImport("gdi32")] public static extern int GetTextMetrics(IntPtr IntPtr, ref TEXTMETRICW lpMetrics);
        [DllImport("gdi32")] public static extern int GetViewportExtEx(IntPtr IntPtr, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int GetViewportOrgEx(IntPtr IntPtr, ref POINT lpPoint);
        [DllImport("gdi32.dll")]
        public static extern uint GetWinMetaFileBits(
     IntPtr hemf,         // Handle to enhanced metafile (HENHMETAFILE)
     int cbBuffer,        // Size of buffer in bytes
     [Out] byte[] lpbBuffer,  // Buffer to receive bits
     int fnMapMode,       // Mapping mode
     IntPtr hdc           // Device context handle (HDC)
 );
        [DllImport("gdi32")] public static extern int GetWindowExtEx(IntPtr IntPtr, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int GetWindowOrgEx(IntPtr IntPtr, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int GetWorldTransform(IntPtr IntPtr, ref XFORM lpXform);
        [DllImport("gdi32")] public static extern int IntersectClipRect(IntPtr IntPtr, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")] public static extern int InvertRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("gdi32")] public static extern int LPtoDP(IntPtr IntPtr, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")] public static extern int LineDDA(int n1, int n2, int n3, int n4, ref int lpLineDDAProc, int lParam);
        [DllImport("gdi32")] public static extern int LineTo(IntPtr IntPtr, int x, int y);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern bool MaskBlt(
     IntPtr hdcDest,       // Handle device context đích
     int nXDest,           // Toạ độ X đích
     int nYDest,           // Toạ độ Y đích
     int nWidth,           // Chiều rộng vùng vẽ
     int nHeight,          // Chiều cao vùng vẽ
     IntPtr hdcSrc,        // Handle device context nguồn
     int nXSrc,            // Toạ độ X nguồn
     int nYSrc,            // Toạ độ Y nguồn
     IntPtr hbmMask,       // Handle bitmap mặt nạ
     int xMask,            // Toạ độ X mặt nạ
     int yMask,            // Toạ độ Y mặt nạ
     uint dwRop            // Raster operation code (ROP)
 );
        [DllImport("gdi32")] public static extern int ModifyWorldTransform(IntPtr IntPtr, ref XFORM lpXform, int iMode);
        [DllImport("gdi32")] public static extern int MoveToEx(IntPtr IntPtr, int x, int y, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int MoveToEx(IntPtr IntPtr, int x, int y, IntPtr lpPoint);
        [DllImport("gdi32")] public static extern int OffsetClipRgn(IntPtr IntPtr, int x, int y);
        [DllImport("gdi32")] public static extern int OffsetRgn(Handle hRgn, int x, int y);
        [DllImport("gdi32")] public static extern int OffsetViewportOrgEx(IntPtr IntPtr, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int OffsetWindowOrgEx(IntPtr IntPtr, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int PaintRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("gdi32")] public static extern int PatBlt(IntPtr IntPtr, int x, int y, int nWidth, int nHeight, int dwRop);
        [DllImport("gdi32")] public static extern int PathToRegion(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int Pie(IntPtr IntPtr, int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
        [DllImport("gdi32")] public static extern int PlayEnhMetaFile(IntPtr IntPtr, Handle hemf, ref RECT lpRect);
        [DllImport("gdi32")] public static extern int PlayEnhMetaFileRecord(IntPtr IntPtr, ref HandleTABLE lpHandletable, ref ENHMETARECORD lpEnhMetaRecord, int nHandles);
        [DllImport("gdi32")] public static extern int PlayMetaFile(IntPtr IntPtr, Handle hMF);
        [DllImport("gdi32")] public static extern int PlayMetaFileRecord(IntPtr IntPtr, ref HandleTABLE lpHandletable, ref METARECORD lpMetaRecord, int nHandles);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern bool PlgBlt(
    IntPtr hdcDest,        // Handle device context đích
    [In] ref POINT lpPoint, // Mảng 3 điểm góc tam giác (3 điểm dùng để vẽ)
    IntPtr hdcSrc,         // Handle device context nguồn
    int nXSrc,             // Toạ độ X nguồn
    int nYSrc,             // Toạ độ Y nguồn
    int nWidth,            // Chiều rộng vùng vẽ
    int nHeight,           // Chiều cao vùng vẽ
    IntPtr hbmMask,        // Handle bitmap mặt nạ (có thể IntPtr.Zero nếu không dùng)
    int xMask,             // Toạ độ X mặt nạ
    int yMask              // Toạ độ Y mặt nạ
);
        [DllImport("gdi32")] public static extern int PolyBezier(IntPtr IntPtr, ref POINT lppt, int cPoints);
        [DllImport("gdi32")] public static extern int PolyBezierTo(IntPtr IntPtr, ref POINT lppt, int cCount);
        [DllImport("gdi32")] public static extern int PolyDraw(IntPtr IntPtr, ref POINT lppt, Byte lpbTypes, int cCount);
        [DllImport("gdi32")] public static extern int PolyPolygon(IntPtr IntPtr, ref POINT lpPoint, ref int lpPolyCounts, int nCount);
        [DllImport("gdi32")] public static extern int PolyPolyline(IntPtr IntPtr, ref POINT lppt, ref int lpdwPolyPoints, int cCount);
        [DllImport("gdi32")] public static extern int PolyTextOut(IntPtr IntPtr, ref POLYTEXT pptxt, int cStrings);
        [DllImport("gdi32")] public static extern int Polygon(IntPtr IntPtr, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")] public static extern int Polyline(IntPtr IntPtr, ref POINT lpPoint, int nCount);
        [DllImport("gdi32")] public static extern int PolylineTo(IntPtr IntPtr, ref POINT lppt, int cCount);
        [DllImport("gdi32")] public static extern bool PtInRegion(Handle hRgn, int x, int y);
        [DllImport("gdi32")] public static extern int PtVisible(IntPtr IntPtr, int x, int y);
        [DllImport("gdi32")] public static extern int RealizePalette(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int RectInRegion(Handle hRgn, ref RECT lpRect);
        [DllImport("gdi32")] public static extern int RectVisible(IntPtr IntPtr, ref RECT lpRect);
        [DllImport("gdi32")] public static extern int Rectangle(IntPtr IntPtr, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")] public static extern int RemoveFontResource(string lpFileName);
        [DllImport("gdi32")] public static extern int ResetDC(IntPtr IntPtr, ref DEVMODE lpInitData);
        [DllImport("gdi32")] public static extern int ResizePalette(Handle hPalette, int nNumEntries);
        [DllImport("gdi32")] public static extern int RestoreDC(IntPtr IntPtr, int nSavedDC);
        [DllImport("gdi32")] public static extern int RoundRect(IntPtr IntPtr, int X1, int Y1, int X2, int Y2, int X3, int Y3);
        [DllImport("gdi32")] public static extern int SaveDC(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int ScaleViewportExtEx(IntPtr IntPtr, int nXnum, int nXdenom, int nYnum, int nYdenom, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int ScaleWindowExtEx(IntPtr IntPtr, int nXnum, int nXdenom, int nYnum, int nYdenom, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int SelectClipPath(IntPtr IntPtr, int iMode);
        [DllImport("gdi32")] public static extern int SelectClipRgn(IntPtr IntPtr, Handle hRgn);
        [DllImport("gdi32.dll")]
        public static extern IntPtr SelectObject(IntPtr hdc, IntPtr hObject);
        [DllImport("gdi32")] public static extern int SelectPalette(IntPtr IntPtr, Handle hPalette, int bForceBackground);
        [DllImport("gdi32.dll", SetLastError = true)]
     ...
     AbortProc lpAbortProc
        ...
        public delegate int AbortProc(IntPtr hdc, int iError);
        [DllImport("gdi32")] public static extern int SetArcDirection(IntPtr IntPtr, int ArcDirection);
        ...
        [DllImport("gdi32")] public static extern int SetBkColor(IntPtr IntPtr, uint crColor);
        [DllImport("gdi32")] public static extern int SetBkMode(IntPtr IntPtr, int nBkMode);
        [DllImport("gdi32")] public static extern int SetBoundsRect(IntPtr IntPtr, ref RECT lprcBounds, int flags);
        [DllImport("gdi32")] public static extern int SetBrushOrgEx(IntPtr IntPtr, int nXOrg, int nYOrg, ref POINT lppt);
        [DllImport("gdi32")] public static extern int SetColorAdjustment(IntPtr IntPtr, ref COLORADJUSTMENT lpca);
        [DllImport("gdi32")] public static extern int SetColorSpace(IntPtr IntPtr, Handle hcolorspace);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern uint SetDIBColorTable(
         IntPtr hdc,          // Device context handle
         uint start,          // Chỉ số bắt đầu bảng màu
         uint count,          // Số màu trong bảng
         [In] RGBQUAD[] colors  // Mảng màu
     );
        [DllImport("gdi32")] public static extern int SetDIBits(IntPtr IntPtr, Handle hBitmap, int nStartScan, int nNumScans, IntPtr lpBits, ref BITMAPINFO lpBI, int wUsage);
        [DllImport("gdi32")] public static extern int SetDIBitsToDevice(IntPtr IntPtr, int x, int y, int dx, int dy, int SrcX, int SrcY, int Scan, int NumScans, IntPtr Bits, BITMAPINFO BitsInfo, int wUsage);
        [DllImport("gdi32")] public static extern int SetDeviceGammaRamp(IntPtr IntPtr, IntPtr lpv);
        [DllImport("gdi32")] public static extern int SetEnhMetaFileBits(int cbBuffer, Byte lpData);
        [DllImport("gdi32")] public static extern int SetGraphicsMode(IntPtr IntPtr, int iMode);
        [DllImport("gdi32")] public static extern int SetICMMode(IntPtr IntPtr, int n);
        [DllImport("gdi32")] public static extern int SetICMProfile(IntPtr IntPtr, string lpStr);
        [DllImport("gdi32")] public static extern int SetMapMode(IntPtr IntPtr, int nMapMode);
        [DllImport("gdi32")] public static extern int SetMapperFlags(IntPtr IntPtr, int dwFlag);
        [DllImport("gdi32")] public static extern int SetMetaFileBitsEx(int nSize, Byte lpData);
        [DllImport("gdi32")] public static extern int SetMetaRgn(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int SetMiterLimit(IntPtr IntPtr, double eNewLimit, double peOldLimit);
        ...
        [DllImport("gdi32")] public static extern int SetPixel(IntPtr IntPtr, int x, int y, int crColor);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern bool SetPixelFormat(IntPtr hdc, int format, ref PIXELFORMATDESCRIPTOR ppfd);

        [DllImport("gdi32")] public static extern int SetPixelV(IntPtr IntPtr, int x, int y, int crColor);
        [DllImport("gdi32")] public static extern int SetPolyFillMode(IntPtr IntPtr, int nPolyFillMode);
        [DllImport("gdi32")] public static extern int SetROP2(IntPtr IntPtr, int nDrawMode);
        [DllImport("gdi32")] public static extern int SetRectRgn(Handle hRgn, int X1, int Y1, int X2, int Y2);
        [DllImport("gdi32")] public static extern int SetStretchBltMode(IntPtr IntPtr, int nStretchMode);
        [DllImport("gdi32")] public static extern int SetSystemPaletteUse(IntPtr IntPtr, int wUsage);
        [DllImport("gdi32")] public static extern int SetTextAlign(IntPtr IntPtr, int wFlags);
        [DllImport("gdi32")] public static extern int SetTextCharacterExtra(IntPtr IntPtr, int nCharExtra);
        [DllImport("gdi32")] public static extern int SetTextColor(IntPtr IntPtr, int crColor);
        [DllImport("gdi32")] public static extern int SetTextJustification(IntPtr IntPtr, int nBreakExtra, int nBreakCount);
        [DllImport("gdi32")] public static extern int SetViewportExtEx(IntPtr IntPtr, int nX, int nY, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int SetViewportOrgEx(IntPtr IntPtr, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32.dll", SetLastError = true)]
       ...
       ref METAFILEPICT lpmfp
        ...
        [DllImport("gdi32")] public static extern int SetWindowExtEx(IntPtr IntPtr, int nX, int nY, ref SIZE lpSize);
        [DllImport("gdi32")] public static extern int SetWindowOrgEx(IntPtr IntPtr, int nX, int nY, ref POINT lpPoint);
        [DllImport("gdi32")] public static extern int SetWorldTransform(IntPtr IntPtr, ref XFORM lpXform);
        [DllImport("gdi32")] public static extern int StartDoc(IntPtr IntPtr, ref DOCINFO lpdi);
        [DllImport("gdi32")] public static extern int StartPage(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int StretchBlt(IntPtr IntPtr, int x, int y, int nWidth, int nHeight, Handle hSrcDC, int xSrc, int ySrc, int nSrcWidth, int nSrcHeight, int dwRop);
        [DllImport("gdi32")] public static extern int StretchDIBits(IntPtr IntPtr, int x, int y, int dx, int dy, int SrcX, int SrcY, int wSrcWidth, int wSrcHeight, IntPtr lpBits, ref BITMAPINFO lpBitsInfo, int wUsage, int dwRop);
        [DllImport("gdi32")] public static extern int StrokeAndFillPath(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int StrokePath(IntPtr IntPtr);
        [DllImport("gdi32.dll", SetLastError = true)]
        public static extern bool SwapBuffers(IntPtr hdc);
        [DllImport("gdi32")]//, EntryPoint = "TextOutW", CharSet = CharSet.Unicode, ExactSpelling = true)] 
        public static extern int TextOut(IntPtr IntPtr, int x, int y, string lpString, int nCount);
        ...
        [DllImport("gdi32")] public static extern int UpdateColors(IntPtr IntPtr);
        [DllImport("gdi32")] public static extern int WidenPath(IntPtr IntPtr);

        [DllImport("msimg32")] // coredll
        extern public static Int32 AlphaBlend(IntPtr IntPtrDest, Int32 xDest, Int32 yDest, Int32 cxDest, Int32 cyDest,
            IntPtr IntPtrSrc, Int32 xSrc, Int32 ySrc, Int32 cxSrc, Int32 cySrc, BLENDFUNCTION blendFunction);
