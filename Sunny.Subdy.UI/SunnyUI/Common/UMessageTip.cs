...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员的 XML 注释
    ...
    public class LayeredWindow : IDisposable
    {
        ...
        private void CreateWindow()
        {
            ...
            _IntPtr = CreateWindowEx(exStyle, ClassName, null, style,
        ...
        protected virtual IntPtr WndProc(IntPtr IntPtr, int msg, IntPtr wParam, IntPtr lParam)
        {
            //Debug.WriteLine((IntPtr == _IntPtr) + "：0x" + Convert.ToString(msg, 16), "WndProc");
            ...
            return DefWndProc(IntPtr, msg, wParam, lParam);
        }

        protected virtual IntPtr DefWndProc(IntPtr IntPtr, int msg, IntPtr wParam, IntPtr lParam) =>
            DefWindowProc(IntPtr, msg, wParam, lParam);
        ...
        private void ShowCore(bool modal)
        {
            ...
            lock (syncObj)
            {
                ...
                CreateWindow();
                ShowWindow(_IntPtr, Activation ? 5/*SW_SHOW*/: 8/*SW_SHOWNA*/);
                Visible = true;
            }
        ...
        protected virtual void Update()
        {
            ...
            //但是为了兼容其他情况，还是都指定
            if (!UpdateLayeredWindow(_IntPtr,
        ...
        //窗口过程委托
        private delegate IntPtr WndProcDelegate(IntPtr IntPtr, int msg, IntPtr wParam, IntPtr lParam);

        #region Win32 API

        [DllImport("user32.dll", SetLastError = true)]
        private static extern IntPtr SetActiveWindow(IntPtr IntPtr);

        [DllImport("user32.dll")]
        private static extern bool EnableWindow(IntPtr IntPtr, bool bEnable);
        ...
        [DllImport("user32.dll")]
        private static extern bool ShowWindow(IntPtr IntPtr, int nCmdShow);

        [DllImport("user32.dll", SetLastError = true)]
        private static extern bool UnregisterClass(string lpClassName, IntPtr hInstance);

        [DllImport("user32.dll")]
        private static extern IntPtr DefWindowProc(IntPtr IntPtr, int Msg, IntPtr wParam, IntPtr lParam);

        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        private static extern short RegisterClass(WNDCLASS wc);

        [DllImport("user32.dll", SetLastError = true)]
        private static extern int GetMessage(ref MSG msg, IntPtr IntPtr, int wMsgFilterMin, int wMsgFilterMax);
        ...
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        private static extern IntPtr CreateWindowEx(int dwExStyle, string lpClassName, string lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, IntPtr IntPtrParent, IntPtr hMenu, IntPtr hInstance, IntPtr lpParam);

        [DllImport("user32.dll", SetLastError = true)]
        private static extern bool UpdateLayeredWindow(IntPtr IntPtr, IntPtr hdcDst, PointOrSize pptDst, PointOrSize pSizeDst, IntPtr hdcSrc, PointOrSize pptSrc, int crKey, ref BLENDFUNCTION pBlend, int dwFlags);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        private static extern bool DestroyWindow(IntPtr IntPtr);
...
#pragma warning restore 414
    ...
    internal static class GraphicsUtils
    {
        ...
        [DllImport("user32.dll")]
        private static extern IntPtr GetDC(IntPtr IntPtr);

        [DllImport("user32.dll")]
        private static extern bool ReleaseDC(IntPtr IntPtr, IntPtr hDC);
